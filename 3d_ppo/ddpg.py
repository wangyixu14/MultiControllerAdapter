...
def MController(state):
	return 0.634*state[0] - 0.296*state[1] - 0.153*state[2] + 0.053*state[0]**2 - 1.215*state[0]**3
...
if __name__ == '__main__':
	...
	agent = Agent(state_size=3, action_size=1, random_seed=random_seed, fc1_units=25, fc2_units=None, individual=False)
